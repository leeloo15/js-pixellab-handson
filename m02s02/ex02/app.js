...
// 1.Afiseaza datele persoanei din formular in DOM.
// 2.In fieldsetul Detalii adauga un input de abilitati numit skills si un buton de + in dreptul sau. La fiecare apasare a butonului, daca in input exista text,
// afiseaza abilitatea noua intr-o lista neordonata.
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push
// 3.In dreptul fiecarui element din lista adauga un buton de stergere. In momentul in care se apasa sterge elementul.
// https://api.jquery.com/remove/
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/splice
// 4.In dreptul fiecarei abilitati din lista neordonata adauga si un buton de editare.
// In momentul in care este apasat, inlocuieste textul cu un input si butoane de salvare si anulare. La salvare, schimba textul abilitatii existente.
// 5.Adauga un checkbox “Are animale de casa” nebifat. In momentul in care acesta este apasat, afiseaza un nou fieldset cu campurile Rasa, Nume si Varsta si un buton de Salvare.
// Cand butonul este apasat, afiseaza in a treia lista neordonata datele fiecarui animal si goleste acele campuri.
// 6. Cand checkboxul este debifat, elimina fieldsetul.
// 7.Adauga un fieldset nou numit friend care sa contina inputuri de nume, prenume si varsta.
// De asemenea un buton de “Add friend”. De fiecare data cand se apasa butonul, afiseaza informatiile prietenului intr-o lista neordonata.
// 8.In dreptul fiecarui prieten, la adaugare, creeaza si un input de abilitati care va adauga intr-o alta lista neordonata sub fiecare element abilitatile prietenului respectiv.
// 9.Adauga functionalitate de editare pentru abilitatile fiecarui prieten.
// 10.Adauga functionalitate de stergere pentru abilitatile fiecauri prieten.
